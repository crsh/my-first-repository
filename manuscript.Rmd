...
out.perm <- apa_print(
  aov_ez(data = tmp.perm, dv = "SRI", within = c("block", "frequency"), id = "id", type = 2)
)
...
out <- apa_print(
  aov_ez(data = tmp, dv = "SRI", id = "id", between = "material", within = "block", type = 2)
)
```
...
out <- apa_print(
  aov_ez(data = tmp2, id = "id", dv = "correct_SOC", between = c("material", "generation", "order"), within = "PD_instruction", type = 2)
)

# separate analysis for free-generation task
tmp.a <- tmp2[tmp2$generation == "Free", ]
out.a <- apa_print(
  aov_ez(data = tmp.a, id = "id", dv = "correct_SOC", between = c("material", "order"), within = "PD_instruction", type = 2)
)

# Post-hoc paired comparisons for free-generation group
fit <- aov_ez(data = tmp.a, id = "id", dv = "correct_SOC", between = c("material", "order"), within = "PD_instruction", type = 2)
...
model <- aov_ez(data = tmp, id = "id", dv = "was_cue", between = c("material", "order"), within = "PD_instruction", type = 2)
out <- apa_print(model)
...
out_1st <- apa_print(
  aov_ez(data = tmp[tmp$block == "first", ], id = "id", dv = "was_cue", between = c("material", "PD_instruction"), type = 2)
)$full_result

out_2nd <- apa_print(
  aov_ez(data = tmp[tmp$block == "second",], id = "id", dv = "was_cue", between = c("material","PD_instruction"), type = 2)
)$full_result
```
